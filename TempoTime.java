...
public class TempoTime {
	...
	private static void createTempoTimeWindow() {
		...
		JLabel instructions = new JLabel(new ImageIcon("Press the key on your keyboard that is in the circle when the circle lights up.pdf"));
